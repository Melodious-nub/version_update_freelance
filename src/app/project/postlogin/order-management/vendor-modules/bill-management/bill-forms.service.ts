...
export class BillFormsService {
  ...
  createBillForm(): UntypedFormGroup {
  ...
  createCostGroup(): UntypedFormGroup {
    return this._fb.group({
      attributeValue: [null],
  ...
  createMediaUrlGroup(): UntypedFormGroup {
    return this._fb.group({
      id: [null],
      fileType: [null],
      rfquotation: [null],
  ...
  createExtendedAccountGroup(): UntypedFormGroup {
    return this._fb.group({
      id: [null],
      debugInformation: [null],
      businessLines: [null],
  ...
  createInvoicePaymentGroup(): UntypedFormGroup {
    return this._fb.group({
      id: this._fb.group({
        invoiceId: [null],
        paymentId: [null],
  ...
  createProductPackageGroup(): UntypedFormGroup {
    return this._fb.group({
      id: [null],
      quantity: [null],
      loadingType: [null],
